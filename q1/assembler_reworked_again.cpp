...
int main()
{
	...
	cerr << endl << "all inputs taken" << endl;

	//print map to cerr 
	cerr << endl << "print map" << endl;
	...
	for (int i=0; i<prog.size(); i++) {
		cerr << endl << "output content is " << prog[i].content << endl;
		out = prog[i].content;
